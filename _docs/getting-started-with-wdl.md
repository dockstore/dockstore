...
## Tutorial Goals
* Learn about the [Workflow Description Language (WDL)](http://www.openwdl.org/)
...
This downloads to my current directory.  I could choose another location, it really doesn't matter.  I'm using a sample I checked in already: `test.wdl.json`.
...
Downloading: bamstatsWorkflow.bam_input from rna.SRR948778.bam to: /home/aduncan/Documents/dockstore-tool-bamstats/cromwell-input/aca839a6-92c4-4234-bc6d-460bcfe6f4d6/rna.SRR948778.bam
...
The final output can be found at `/home/aduncan/Documents/dockstore-tool-bamstats/cromwell-executions/bamstatsWorkflow/4d24ebd1-5151-4b07-82d7-272b184fd0eb/call-bamstats/execution/bamstats_report.zip`.
