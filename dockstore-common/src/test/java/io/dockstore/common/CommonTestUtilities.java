...
public class CommonTestUtilities {
    ...
    public static class TestingPostgres extends BasicPostgreSQL {
        ...
        public void clearDatabase() {
            ...
            runInsertStatement(
                    "insert into tool(id, name, namespace, registry, path, ispublished, toolname, verified, verifiedsource) VALUES (1, 'test1', 'test_org', 'QUAY_IO', 'quay.io/test_org/test1', false,'', false, null);",
                    new KeyedHandler<>("id"));
            runInsertStatement("insert into user_entry(userid, entryid) VALUES (1, 1);", new KeyedHandler<>("entryid"));
            runInsertStatement(
                    "insert into tool(id, name, namespace, registry, path, ispublished,toolname, verified, verifiedsource) VALUES (2, 'test2', 'test_org', 'QUAY_IO', 'quay.io/test_org/test2', false,'', false, null);",
                    new KeyedHandler<>("id"));
            runInsertStatement("insert into user_entry(userid, entryid) VALUES (2, 2);", new KeyedHandler<>("entryid"));
            runInsertStatement(
                    "insert into tool(id, name, namespace, registry, path, ispublished,toolname, verified, verifiedsource) VALUES (3, 'test3', 'test_org', 'QUAY_IO', 'quay.io/test_org/test3', false,'', false, null);",
                    new KeyedHandler<>("id"));
            runInsertStatement("insert into user_entry(userid, entryid) VALUES (2, 3);", new KeyedHandler<>("entryid"));
            runInsertStatement(
                    "insert into tool(id, name, namespace, registry, path, ispublished, giturl,toolname, verified, verifiedsource) VALUES (4, 'test4', 'test_org', 'QUAY_IO', 'quay.io/test_org/test4', false, 'git@github.com:test/test4.git','', false, null);",
                    new KeyedHandler<>("id"));
            runInsertStatement("insert into user_entry(userid, entryid) VALUES (2, 4);", new KeyedHandler<>("entryid"));
            runInsertStatement(
                    "insert into tool(id, name, namespace, registry, path, ispublished, giturl,toolname, verified, verifiedsource) VALUES (5, 'test5', 'test_org', 'QUAY_IO', 'quay.io/test_org/test5', false, 'git@github.com:test/test5.git','', false, null);",
                    new KeyedHandler<>("id"));
            runInsertStatement("insert into user_entry(userid, entryid) VALUES (2, 5);", new KeyedHandler<>("entryid"));
            runInsertStatement(
                    "insert into tool(id, name, namespace, registry, path, ispublished, giturl,toolname, verified, verifiedsource) VALUES (6, 'test6', 'test_org', 'QUAY_IO', 'quay.io/test_org/test6', true, 'git@github.com:test/test6.git','', false, null);",
                    new KeyedHandler<>("id"));
            ...
            runInsertStatement("insert into tag(id, valid, automated, hidden, size, cwlpath, wdlpath, dockerfilepath, dirtybit) VALUES (1, true, true, false, 0,'/Dockstore.cwl', '/Dockstore.wdl', '/Dockerfile', false);", new KeyedHandler<>(
                    "id"));
            runInsertStatement("insert into tool_tag(toolid, tagid) VALUES (6, 1);", new KeyedHandler<>("tagid"));

            runInsertStatement("insert into tag(id, valid, automated, hidden, size, cwlpath, wdlpath, dockerfilepath, dirtybit) VALUES (2, true, true, false, 0,'/Dockstore.cwl', '/Dockstore.wdl', '/Dockerfile', false);", new KeyedHandler<>(
                    "id"));
