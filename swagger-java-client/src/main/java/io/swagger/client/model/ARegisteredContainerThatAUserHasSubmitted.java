...
public class ARegisteredContainerThatAUserHasSubmitted   {
  ...
  private List<AParticularTokenThatAUserHasSubmittedViaOAuth> tags = new ArrayList<AParticularTokenThatAUserHasSubmittedViaOAuth>();
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("tags")
  public List<AParticularTokenThatAUserHasSubmittedViaOAuth> getTags() {
    return tags;
  }
  public void setTags(List<AParticularTokenThatAUserHasSubmittedViaOAuth> tags) {
    this.tags = tags;
  }
  ...
  public String toString()  {
    ...
    sb.append("class ARegisteredContainerThatAUserHasSubmitted {\n");
