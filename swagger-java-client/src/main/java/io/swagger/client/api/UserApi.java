...
import io.swagger.client.model.GithubRegisterView;
...
public class UserApi {
   ...
   * @return String
   */
  public String addGroupToUser (Long userId, Long groupId) throws ApiException {
    Object postBody = null;
   ...
   * Does not work. Need to add group to user. This is because the user is defined as the &#39;owner&#39;. It can be implemented the other way around.
   * @param userId 
   * @param groupId 
   * @return String
   */
  public String addUserToGroup (Long userId, Long groupId) throws ApiException {
    Object postBody = null;
   ...
   * 
   * 
   * @return GithubRegisterView
   */
  public GithubRegisterView registerGithub () throws ApiException {
    Object postBody = null;
    ...
    TypeRef returnType = new TypeRef<GithubRegisterView>() {};
    return apiClient.invokeAPI(path, "GET", queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
   ...
   * @return User
   */
  public User registerGithubRedirect (String code) throws ApiException {
    Object postBody = null;
   ...
   * @return User
   */
  public User registerUser (String username, String password, Boolean isAdmin) throws ApiException {
    Object postBody = null;
