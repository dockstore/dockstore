...
public class WorkflowEntryDTO extends EntryDTO {
    private final WorkflowPath workflowPath;

    @SuppressWarnings("checkstyle:ParameterNumber")
    public WorkflowEntryDTO(final long id, final String organization, final String description, SourceControl sourceControl,
