...
public class VersionMetadata {
    ...
    @Column(columnDefinition =  "boolean default false")
    @Schema(description = "Indicates if the DOI is generated by Dockstore's Zenodo account instead of the user's own Zenodo account")
    protected boolean dockstoreOwnedDoi = false;
