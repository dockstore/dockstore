...
@NamedQueries({
    ...
    @NamedQuery(name = "io.dockstore.webservice.core.WorkflowVersion.getPublicVersionsByWorkflowId", query = "FROM WorkflowVersion v WHERE v.parent.id = :id AND v.versionMetadata.hidden = false ORDER by lastModified DESC"),
