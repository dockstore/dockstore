...
@NamedQueries({
        ...
        @NamedQuery(name = "io.dockstore.webservice.core.WorkflowVersion.getByWorkflowId", query = "FROM WorkflowVersion v WHERE v.parent.id = :id ORDER by GREATEST (dbUpdateDate, lastmodified) DESC")
})
