...
@NamedQueries({
        ...
        @NamedQuery(name = "io.dockstore.webservice.core.Workflow.findPublishedByOrganization", query = "SELECT c FROM Workflow c WHERE c.organization = :organization AND c.isPublished = true"),
