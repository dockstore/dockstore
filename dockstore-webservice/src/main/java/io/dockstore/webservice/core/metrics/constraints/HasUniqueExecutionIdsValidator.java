...
/**
 * Validates that ExecutionsRequestBody has unique execution IDs.
 */
public class HasUniqueExecutionIdsValidator implements ConstraintValidator<HasUniqueExecutionIds, ExecutionsRequestBody> {
