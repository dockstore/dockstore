...
public abstract class Entry<S extends Entry, T extends Version> implements Comparable<Entry>, Aliasable {
    ...
    @Column
    @ApiModelProperty(value = "This is the default version of the entry")
    ...
    @ApiModelProperty(value = "Implementation specific timestamp for last modified. "
            ...
            + "Workflows-> For remote: When refresh is hit, last time GitHub repo was changed. Hosted: Last time a new version was made.")
    ...
    @ApiModelProperty(value = "Implementation specific timestamp for last updated on webservice. "
            ...
            + "Workflows-> For remote: When refresh all is hit for first time. Hosted: Seems to be time created.")
    ...
    @Column
    @ApiModelProperty(value = "The Digital Object Identifier (DOI) representing all of the versions of your workflow")
