...
@NamedQueries({
        ...
        @NamedQuery(name = "io.dockstore.webservice.core.Organization.findByName", query = "SELECT org FROM Organization org WHERE org.name = :name"),
        ...
        @NamedQuery(name = "io.dockstore.webservice.core.Organization.findApprovedByName", query = "SELECT org FROM Organization org WHERE org.name = :name AND org.status = 'APPROVED'")
})
