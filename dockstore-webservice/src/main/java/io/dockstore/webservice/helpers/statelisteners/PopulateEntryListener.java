...
public class PopulateEntryListener implements StateListenerInterface {
    ...
    private void populate(List<Entry> entries) {
        ...
        Map<Long, List<CategorySummary>> entryIdToCategories = entryDAO.findCategorySummariesByEntryIds(entryIds);
        ...
        entries.forEach(entry -> {
            entry.setCategorySummaries(entryIdToCategories.getOrDefault(entry.getId(), Collections.emptyList()));
