...
public class ToolsApi {
    ...
    @UnitOfWork
    @Produces({ "application/json", "text/plain" })
    @io.swagger.annotations.ApiOperation(value = "List all tools", notes = "This endpoint returns all tools available or a filtered subset using metadata query parameters. ", response = ToolV2.class, responseContainer = "List", tags = {
            "GA4GHV2", })
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "An array of Tools that match the filter.", response = ToolV2.class, responseContainer = "List") })
    ...
    @UnitOfWork
    @Produces({ "application/json", "text/plain" })
    @io.swagger.annotations.ApiOperation(value = "List one specific tool, acts as an anchor for self references", notes = "This endpoint returns one specific tool (which has ToolVersions nested inside it)", response = ToolV2.class, tags = {
            "GA4GHV2", })
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "A tool.", response = ToolV2.class) })
    public Response toolsIdGet(
            ...
            @Context SecurityContext securityContext, @Context ContainerRequestContext value) throws NotFoundException {
        return ApiVersionConverter.convertToVersion(delegate.toolsIdGet(id, securityContext, value), ApiVersionConverter.ApiVersion.v2);
    }
    ...
    @UnitOfWork
    @Produces({ "application/json", "text/plain" })
    @io.swagger.annotations.ApiOperation(value = "List versions of a tool", notes = "Returns all versions of the specified tool", response = ToolVersionV2.class, responseContainer = "List", tags = {
            "GA4GHV2", })
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "An array of tool versions", response = ToolVersionV2.class, responseContainer = "List") })
    public Response toolsIdVersionsGet(
            @ApiParam(value = "A unique identifier of the tool, scoped to this registry, for example `123456`", required = true) @PathParam("id") String id,
            @Context SecurityContext securityContext, @Context ContainerRequestContext value) throws NotFoundException {
        return ApiVersionConverter.convertToVersion(delegate.toolsIdVersionsGet(id, securityContext, value), ApiVersionConverter.ApiVersion.v2);
    }
    ...
    public Response toolsIdVersionsVersionIdDockerfileGet(
            ...
            @Context SecurityContext securityContext, @Context ContainerRequestContext value) throws NotFoundException {
        return ApiVersionConverter.convertToVersion(delegate.toolsIdVersionsVersionIdDockerfileGet(id, versionId, securityContext, value), ApiVersionConverter.ApiVersion.v2);
    }
    ...
    @UnitOfWork
    @Produces({ "application/json", "text/plain" })
    @io.swagger.annotations.ApiOperation(value = "List one specific tool version, acts as an anchor for self references", notes = "This endpoint returns one specific tool version", response = ToolVersionV2.class, tags = {
            "GA4GHV2", })
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "A tool version.", response = ToolVersionV2.class) })
    public Response toolsIdVersionsVersionIdGet(
            ...
            @Context SecurityContext securityContext, @Context ContainerRequestContext value) throws NotFoundException {
        return ApiVersionConverter.convertToVersion(delegate.toolsIdVersionsVersionIdGet(id, versionId, securityContext, value), ApiVersionConverter.ApiVersion.v2);
    }
    ...
    public Response toolsIdVersionsVersionIdTypeDescriptorGet(
            ...
            @ApiParam(value = "An identifier of the tool version for this particular tool registry, for example `v1`", required = true) @PathParam("version_id") String versionId,
            @Context SecurityContext securityContext, @Context ContainerRequestContext value) throws NotFoundException {
        return ApiVersionConverter.convertToVersion(delegate.toolsIdVersionsVersionIdTypeDescriptorGet(type, id, versionId, securityContext, value), ApiVersionConverter.ApiVersion.v2);
    }
    ...
    @Produces({ "application/json", "text/plain" })
    @io.swagger.annotations.ApiOperation(value = "Get an array of test JSONs suitable for use with this descriptor type.", notes = "", response = ToolFile.class, responseContainer = "List", tags={ "GA4GH", })
    @io.swagger.annotations.ApiResponses(value = {
    ...
    public Response toolsIdVersionsVersionIdTypeFilesGet(@ApiParam(value = "The output type of the descriptor. If not specified it is up to the underlying implementation to determine which output type to return. Plain types return the bare descriptor while the \"non-plain\" types return a descriptor wrapped with metadata. Allowable values are \"CWL\", \"WDL\", \"PLAIN_CWL\", \"PLAIN_WDL\".",required=true) @PathParam("type") String type
            ,@ApiParam(value = "A unique identifier of the tool, scoped to this registry, for example `123456`",required=true) @PathParam("id") String id
            ,@ApiParam(value = "An identifier of the tool version for this particular tool registry, for example `v1`",required=true) @PathParam("version_id") String versionId
    ...
    public Response toolsIdVersionsVersionIdTypeTestsGet(
            ...
            @ApiParam(value = "An identifier of the tool version for this particular tool registry, for example `v1`", required = true) @PathParam("version_id") String versionId,
            @Context SecurityContext securityContext, @Context ContainerRequestContext value) throws NotFoundException {
        return ApiVersionConverter.convertToVersion(delegate.toolsIdVersionsVersionIdTypeTestsGet(type, id, versionId, securityContext, value), ApiVersionConverter.ApiVersion.v2);
    }
}
