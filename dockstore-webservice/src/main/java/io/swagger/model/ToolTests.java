...
public class ToolTests {
    ...
    @JsonProperty("test_tool_url")
    private String testToolUrl = null;
    ...
    public ToolTests testToolUrl(String testToolUrl) {
        this.testToolUrl = testToolUrl;
        return this;
    }

    /**
     * Optional url to the test workflow that will exit successfully if this workflow produced the expected result given this test data.
     *
     * @return testToolUrl
     **/
    @JsonProperty("test_tool_url")
    @ApiModelProperty(value = "Optional url to the test workflow that will exit successfully if this workflow produced the expected result given this test data.")
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.test, toolTests.test) && Objects.equals(this.url, toolTests.url) && Objects
            .equals(this.testToolUrl, toolTests.testToolUrl);
    }

    @Override
    public int hashCode() {
        return Objects.hash(test, url, testToolUrl);
    }
    ...
    public String toString() {
        ...
        sb.append("    testToolUrl: ").append(toIndentedString(testToolUrl)).append("\n");
        sb.append("}");
        return sb.toString();
    }
