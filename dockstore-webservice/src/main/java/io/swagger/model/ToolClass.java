...
public class ToolClass {
   ...
   * @return id
   **/
  @ApiModelProperty(value = "The unique identifier for the class") public String getId() {
    return id;
  }
   ...
   * @return name
   **/
  @ApiModelProperty(value = "A short friendly name for the class") public String getName() {
    return name;
  }
   ...
   * @return description
   **/
  @ApiModelProperty(value = "A longer explanation of what this class is and what it can accomplish") public String getDescription() {
    return description;
  }
