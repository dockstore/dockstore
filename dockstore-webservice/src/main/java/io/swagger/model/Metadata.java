 ...
 * Describes this registry to better allow for mirroring and indexing.
 */
@ApiModel(description = "Describes this registry to better allow for mirroring and indexing.") @javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaJerseyServerCodegen", date = "2016-09-12T21:34:41.980Z") public class Metadata {
   ...
   * @return version
   **/
  @ApiModelProperty(required = true, value = "The version of this registry") public String getVersion() {
    return version;
  }
   ...
   * @return apiVersion
   **/
  @ApiModelProperty(required = true, value = "The version of the GA4GH tool-registry API supported by this registry") public String getApiVersion() {
    return apiVersion;
  }
   ...
   * @return country
   **/
  @ApiModelProperty(value = "A country code for the registry (ISO 3166-1 alpha-3)") public String getCountry() {
    return country;
  }
   ...
   * @return friendlyName
   **/
  @ApiModelProperty(value = "A friendly name that can be used in addition to the hostname to describe a registry") public String getFriendlyName() {
    return friendlyName;
  }
