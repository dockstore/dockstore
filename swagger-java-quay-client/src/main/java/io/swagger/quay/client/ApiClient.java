...
import io.swagger.quay.client.auth.Authentication;
import io.swagger.quay.client.auth.HttpBasicAuth;
import io.swagger.quay.client.auth.ApiKeyAuth;
import io.swagger.quay.client.auth.OAuth;
...
public class ApiClient {
  ...
  private String basePath = "https://quay.io/";
  ...
  public ApiClient() {
    ...
    authentications.put("oauth2_implicit", new OAuth());
