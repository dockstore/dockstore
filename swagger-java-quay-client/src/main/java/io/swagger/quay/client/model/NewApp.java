 ...
 **/
@ApiModel(description = "Description of a new organization application.")
...
public class NewApp   {
   ...
   **/
  @ApiModelProperty(value = "The URI for the application's OAuth redirect")
   ...
   **/
  @ApiModelProperty(value = "The URI for the application's homepage")
