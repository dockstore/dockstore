...
public class CRUDClientIT extends BaseIT {
    ...
    public void testToolCreation(){
        ApiClient webClient = getWebClient("admin@admin.com");
    ...
    public void testToolEditing(){
        HostedApi api = new HostedApi(getWebClient("admin@admin.com"));
        DockstoreTool hostedTool = api.createHostedTool("awesomeTool", "cwl", "quay.io", "coolNamespace");
        ...
        // Publish tool
        ContainersApi containersApi = new ContainersApi(getWebClient("admin@admin.com"));
    ...
    public void testWorkflowEditing(){
        ...
        // Publish workflow
        WorkflowsApi workflowsApi = new WorkflowsApi(getWebClient("admin@admin.com"));
        PublishRequest pub = SwaggerUtility.createPublishRequest(true);
