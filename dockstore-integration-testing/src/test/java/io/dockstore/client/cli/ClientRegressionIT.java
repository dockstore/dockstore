...
//        Assert.assertTrue(stringStringImmutablePair.getLeft().contains(version));
    ...
    public void testCacheCleaningOld() throws IOException {
        ImmutablePair<String, String> stringStringImmutablePair = CommonTestUtilities.runOldDockstoreClient(dockstore, new String[] {"--config", TestUtility.getConfigFileLocation(true), "--clean-cache" });
        systemOutRule.clearLog();
    }
