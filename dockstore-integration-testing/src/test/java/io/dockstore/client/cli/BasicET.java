...
public class BasicET {
        ...
        /**
         * Tests altering the cwl and dockerfile paths to invalid locations
         */
        @Test
        ...
        /**
         * Tests hiding and unhiding different versions of a container
         */
        @Test
        ...
        public void testVersionTagDelete() {
                ...
                final CommonTestUtilities.TestingPostgres testingPostgres = getTestingPostgres();
                final long count = testingPostgres.runSelectStatement("select count(*) from tag where name = 'master'", new ScalarHandler<>());
                Assert.assertTrue("there should be only 4 tags, all from the automated quay containers", count == 4);
        }
