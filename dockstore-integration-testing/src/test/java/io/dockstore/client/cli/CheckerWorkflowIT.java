...
public class CheckerWorkflowIT extends BaseIT {
    ...
    public void testCWLToolAddCheckerRefreshPublishUnpublish() throws ApiException {
        ...
        Assert.assertTrue(refresh.getTags().stream().anyMatch(tag -> tag.getFileFormats().contains("http://edamontology.org/data_3671")));
        Assert.assertTrue(refresh.getFileFormats().contains("http://edamontology.org/data_3671"));
