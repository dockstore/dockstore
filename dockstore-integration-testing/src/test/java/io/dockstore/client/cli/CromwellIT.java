...
public class CromwellIT {
    ...
    public void runWDLWorkflow() throws IOException, ApiException {
        ...
        // run a workflow
        final long run = wdlClient.launch(workflowFile.getAbsolutePath(), true, null, parameterFile.getAbsolutePath(), null, null, null, null);
    ...
    public void fileProvisioning() throws IOException, ApiException {
        ...
        // run a workflow
        final long run = wdlClient.launch(workflowFile.getAbsolutePath(), true, null, newJsonPath, null, tempDir.getAbsolutePath(), null, null);
        Assert.assertEquals(0, run);
