    ...
    public final SystemErrRule systemOutRule = new SystemErrRule().enableLog();
        ...
        */
        ...
        public void testAddVersionTagManualContainer() {
                ...
                assertTrue("there should be 3 tags, 2  that are autogenerated (master and latest) and the newly added masterTest tag, found " + count, count == 3);
    ...
    public void testCWL2YAML() {
        ...
        public void testLocalLaunchCWL() {
                Client.main(new String[] { "--config", ResourceHelpers.resourceFilePath("config_file2.txt"), "tool", "launch", "--local-entry",
                        ResourceHelpers.resourceFilePath("arrays.cwl") , "--json", ResourceHelpers.resourceFilePath("testArrayHttpInputLocalOutput.json"), "--script" });
        }
