...
public class BasicIT extends BaseIT {
    ...
    public void testRegistrationWithNonLowerCase() {
        ...
        Workflow workflow = workflowsApi
                .getWorkflowByPath(SourceControl.GITHUB.toString() + "/DockstoreTestUser/dockstore-whalesay-wdl", "", BIOWORKFLOW, null);
    ...
    public void testBrokenPath() {
        ...
        WorkflowsApi workflowsApi = new WorkflowsApi(client);
        try {
            workflowsApi.getWorkflowByPath("potato", "potato", BIOWORKFLOW, null);
