...
public class GalaxyPluginIT {
    ...
    public void testTestParameterPaths() {
        ...
        Workflow workflow = workflowApi.getWorkflowByPath("github.com/" + galaxyWorkflowRepo + "/COVID-19 variation analysis on Illumina metagenomic data", "versions", BaseIT.BIOWORKFLOW);
