...
public final class Hoverfly {
    ...
    public static final SimulationSource ZENODO_SIMULATION_SOURCE = dsl(service(ZENODO_SIMULATION_URL)
            ...
            // getDeposits
            .get(RequestFieldMatcher.newRegexMatcher("/api/deposit/depositions")).anyBody().anyQueryParams().willReturn(success(fixture("fixtures/emptyArray.json"), MediaType.APPLICATION_JSON))
            // newDepositVersion
