...
<html>
    <body>
        ...
        <p>redirectURI: http://localhost:8080/user/registerGithubRedirect</p>
         ...
         <a href="https://github.com/login/oauth/authorize?redirect_uri=http://localhost:8080/user/registerGithubRedirect&client_id=${parent.githubClientID?html}&scope=repo:read">Authorization link</a> 
    </body>
</html>
