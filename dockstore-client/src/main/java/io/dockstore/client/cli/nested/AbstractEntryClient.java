...
public abstract class AbstractEntryClient {
    ...
    public void printGeneralHelp() {
        ...
        out("");
        out("  " + CWL_STRING + " <" + getEntryType() + ">       :  returns the Common Workflow Language " + getEntryType() + " definition for this entry");
        out("                      which enables integration with Global Alliance compliant systems");
        out("");
        out("  " + WDL_STRING + " <" + getEntryType() + ">       :  returns the Workflow Descriptor Langauge definition for this Docker image.");
        out("");
