...
public final class LanguageHandlerHelper {
  ...
  public static String convertRelativePathToAbsolutePath(String parentPath, String relativePath) {
    ...
    // If the workDir is the root, leave it. If it is not the root, set workDir to the parent of
    // parentPath
    workDir =
        !Objects.equals(parentPath, workDir.getRoot().toString()) ? workDir.getParent() : workDir;
