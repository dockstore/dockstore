...
Some tools/workflows require Docker images to launch even if it's a local entry.  If the compute nodes do not have internet access, you can follow these steps:
